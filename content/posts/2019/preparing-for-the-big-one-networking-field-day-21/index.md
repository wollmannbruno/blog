...
[Networking Field Day 21](https://techfieldday.com/event/nfd21/), NFD21 for short, consists of 13 vendors presenting to 17 different delegates over four days in Silicone Valley from October 1 to 4, 2019.

This event will mark my 3rd time as a delegate. I previously attended [NFD18](https://techfieldday.com/event/nfd18/) and [CLUS19](https://techfieldday.com/event/clus19/) and collected some thoughts in [this](http://brunowollmann.com/2018/07/networking-field-day-18-wrap-up/) post.
...
**Arrcus** produces a Linux-based network operating system called ArcOS that will work on any system based on the Jericho2 chipset. Jericho2 supports 100Gbps to 400Gbps interfaces in a high-density form factor. The marketing material on their website shows this disaggregated system, also known as white-box switching, being deployed virtually anywhere from remote offices to data centres to WAN environments and even to public clouds.
...
**Cisco** is the most well-known networking company in the world and the one I am most familiar with. They have been innovating across many verticals for many years. Their presentation could be about anything. I hope it’s about automation and orchestration as I’ve been actively adding these to my skill set.
...
**Forward Networks** is the creator of Forward Enterprise. Some of the use cases outlined are to create network documentation and visualization as well as perform network and configuration audits. The tag line on their website is “Network Automation and Verification for your Intent-Based Network.”
...
**Testuto** offers a multi-vendor, cloud-based virtual lab. Like many networkers, I have experience with small, VM-based labs. I’m interested to see the scaling and performance numbers for this solution.

## The You

You can also participate in [NFD21](https://techfieldday.com/event/nfd21/) as the presentations will be live-streamed at the event website. Engaging in the conversation is as easy as playing along on Twitter. The #NFD21 hashtag is what will get your comments and questions noticed by the delegates in attendance. Your questions will then be relayed to the presenters. You can also tweet directly @ me, [@wollmannbruno](https://twitter.com/wollmannbruno/), and I will make sure to proxy your questions. Tweeting directly @ any of the other delegates will have the same result.

If you would like to become a delegate, check out [this](https://techfieldday.com/delegates/become-field-day-delegate/) link.
