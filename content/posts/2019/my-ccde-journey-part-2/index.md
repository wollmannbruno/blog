...
[Part 1](https://brunowollmann.com/2019/05/my-ccde-journey-part-1/) provided you with information about the program. [Part 3](https://brunowollmann.com/2020/01/my-ccde-journey-part-3/) talks about exam day and my strategies for the exam itself.
...
With the exceptions of “Evolving Technologies Study Guide” and “CCDE In Depth,” I was able to access the entire reading list from [O’Reilly](https://www.oreilly.com/) using my [Association for Computing Machinery](https://www.acm.org/) membership.
...
One way to do this is to let [RFC1925](https://tools.ietf.org/html/rfc1925/) rule 11 be your friend. There exist many protocols and technologies created to solve the same problem. If you understand the fundamental problem being solved, you are well on your way to understanding the foundation of a proposed solution.
...
**Mind maps:** I had never used mind maps for anything until I started studying for CCDE, and now I use them for everything. Even this blog post started as a mind map. The maps I created were used to describe broader concepts like MPLS or Multicast. Here is the mind map I created for [IPv6 transition technologies](IPv6-Transition-Technologies.pdf).
